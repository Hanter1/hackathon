            ...
            <div class="container">
                <div class="members-section-top__inner">
                    <div class="members-section-top__img">
                        <img class="members-section-top__img-image" src="images/member-icon-16.png" alt="img">
                    </div>
                    ...
                    <div class="members-section__wrapper" id="0">
                                        ...
                                        <div class="post-body__top post-body-top">
                                            <a class="post-body-top__link" href="#">
                                                <img class="post-body-top__link-img"
                                                     src="images/member-icon-11.png" alt="img">
                                            </a>
                                        ...
                                        <div class="post-body__view post-body-view">
                                            <a class="post-body-view__link" href="#">
                                                <img class="post-body-view__link-img"
                                                     src="images/new/ga1.jpg" alt="img">
                                            </a>
                                        </div>
                                            ...
                                            <div class="post-body-info__box post-body-info-box">
                                                <ul class="post-body-info-box__list post-body-info-box-list">
                                                    ...
                                                    <li class="post-body-info-box-list__item">
                                                        <a class="post-body-info-box-list__link" href="#">
                                                            <img class="post-body-info-box-list__link-img"
                                                                 src="images/member-icon-20.png" alt="img">
                                                        </a>
                                                    </li>
                                                    <li class="post-body-info-box-list__item">
                                                        <a class="post-body-info-box-list__link" href="#">
                                                            <img class="post-body-info-box-list__link-img"
                                                                 src="images/member-icon-26.png" alt="img">
                                                        </a>
                                                    </li>
                                                    <li class="post-body-info-box-list__item">
                                        ...
                                        <div class="comments__inner">
                                                ...
                                                <div class="comments__item comments-item">
                                                    ...
                                                    <div class="comments-item__img">
                                                        <img class="comments-item__image"
                                                             src="images/member-icon-13.png" alt="img">
                                                    </div>
                                            ...
                                            <div class="comments__wrapper">
                                                <div class="comments__item comments-item">
                                                    ...
                                                    <div class="comments-item__img">
                                                        <img class="comments-item__image"
                                                             src="images/member-icon-17.png" alt="img">
                                                    </div>
                                                    <div class="comments-item__inner">
                                                        <p class="comments-item__name">
                                                            Tina Alvarez
                                            ...
                                            <div class="post-body-content__group-card group-card">
                                                ...
                                                <div class="group-card__img group-card-img">
                                                    <img class="group-card-img__image"
                                                         src="images/group-img-15.jpg" alt="img">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="post-body__info post-body-info">
                                            <div class="post-body-info__box post-body-info-box">
                                                <ul class="post-body-info-box__list post-body-info-box-list">
                                                    <li class="post-body-info-box-list__item">
                                                        <a class="post-body-info-box-list__link" href="#">
                                                            <img class="post-body-info-box-list__link-img"
                                                                 src="images/member-icon-4.png" alt="img">
                                                        </a>
                                                    </li>
                                                    <li class="post-body-info-box-list__item">
                                                        <a class="post-body-info-box-list__link" href="#">
                                    ...
                                    <div class="post__body post-body">
                                        ...
                                        <div class="post-body__user-card user-card">
                                            <a class="user-card__link" href="#">
                                                <img class="user-card__link-img" src="images/member-icon-8.png"
                                                     alt="img">
                                            </a>
                                        ...
                                        <div class="comments__inner">
                                            <div class="comments__wrapper">
                                                <div class="comments__item comments-item">
                                                    ...
                                                    <div class="comments-item__img">
                                                        <img class="comments-item__image"
                                                             src="images/member-icon-9.png" alt="img">
                                                    </div>
                                                    <div class="comments-item__inner">
                                                        <p class="comments-item__name">
                                                            Tina Alvarez
                        ...
                        <aside class="members-section__aside members-section-aside">
                            <div class="members-section-aside__aside-block aside-block">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-4.png"
                                             alt="img">
                                    </a>
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-9.png"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-17.png"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-19.png"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                            ...
                            <div class="members-section-aside__aside-block aside-block aside-block--small-squeres">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-14.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-15.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-1.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-10.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                            ...
                            <div class="members-section-aside__aside-block aside-block">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-14.png"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                            ...
                            <div class="members-section-aside__aside-block aside-block aside-block--medium-squeres">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-11.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-6.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-4.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/group-img-2.jpg"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                            ...
                            <div class="members-section-aside__aside-block aside-block aside-block--grid">
                                ...
                                <div class="aside-block__media aside-block-media">
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-32.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-1.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/course-img-2.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/course-img-4.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-2.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-37.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-27.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-4.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/group-img-39.jpg" alt="img">
                                    </a>
                                </div>
                                <a class="aside-block__link" href="#">
                                    Show All
                    ...
                    <div class="members-section__wrapper  members-section__wrapper--active" id="1">
                                    ...
                                    <ul class="profile-info-instruments__list">
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-1.svg" alt="img">
                                            </div>
                                            Figma
                                        </li>
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-2.svg" alt="img">
                                            </div>
                                            Sketch
                                        </li>
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-3.svg" alt="img">
                                            </div>
                                            Photoshop
                                        </li>
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-4.svg" alt="img">
                                            </div>
                                            Illustrator
                                        </li>
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-5.svg" alt="img">
                                            </div>
                                            Invision
                                        </li>
                                        <li class="profile-info-instruments__list-item">
                                            <div class="profile-info-instruments__list-icon">
                                                <img src="images/profile-info-instruments-icon-6.png" alt="img">
                                            </div>
                                            Readymag
                                        </li>
                                    </ul>
                                </div>
                                <div class="profile-info__experience profile-info-experience">
                                    <h2 class="profile-info-experience__title">
                                        Work & Experience
                                    </h2>
                                    <div class="profile-info-experience__inner">
                                        <div class="profile-info-experience__box profile-info-experience-box">
                                            <p class="profile-info-experience-box__suptext">
                                                2020-2022
                                            </p>
                                            <p class="profile-info-experience-box__speciality">
                                                Product Designer
                                            </p>
                                            <p class="profile-info-experience-box__subtext">
                                                Momentum Design Lab — Barcelona, Spain
                                            </p>
                                            <p class="profile-info-experience-box__text">
                                                I worked as a product designer at Momentum Design Lab, where I was
                                                able
                                                to
                                                showcase my expertise in designing user-centric products that are
                                                both
                                        ...
                                        <div class="profile-info-experience__box profile-info-experience-box">
                                            ...
                                            <p class="profile-info-experience-box__subtext">
                                                Diseño Web Profesional Studio — Barcelona, Spain
                                            </p>
                                            <p class="profile-info-experience-box__text">
                                                I served as a senior UX/UI designer at Diseño Web Profesional
                                                Studio,
                                                where
                                                I was responsible for delivering top-notch designs that exceeded
                                                customer
                                                expectations.
                                            </p>
                                        </div>
                                        <div class="profile-info-experience__box profile-info-experience-box">
                                            ...
                                            <p class="profile-info-experience-box__subtext">
                                                Mediactiu Estudio de Diseño Gráfico y Diseño Web en Barcelona —
                                                Barcelona,
                                                Spain
                                            </p>
                                            <p class="profile-info-experience-box__text">
                                                As a UX/UI Designer, performed activities throughout the whole
                                                design
                                                process:
                                            </p>
                                            <ul class="profile-info-experience-box__list">
                                                <li class="profile-info-experience-box__list-item">
                                                ...
                                                <li class="profile-info-experience-box__list-item">
                                                    - Performed
                                                    Competitor Analysis and presented the results;
                                                </li>
                                                <li class="profile-info-experience-box__list-item">
                                                    - Conducted User
                                                    Interviews;
                                                ...
                                                <li class="profile-info-experience-box__list-item">
                                                    - Done target audience segmentation and created CJM- Created
                            ...
                            <section class="members-section__portfolio portfolio">
                                ...
                                <div class="portfolio__inner">
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga1.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga2.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga3.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga4.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga5.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga6.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga7.jpg"
                                             alt="img">
                                    </a>
                                    <a class="portfolio__link" href="#">
                                        <img class="portfolio__link-img" src="images/new/ga8.jpg"
                                             alt="img">
                                    </a>
                                </div>
                        ...
                        <aside class="members-section__aside members-section-aside">
                            ...
                            <div class="members-section-aside__aside-block aside-block">
                                ...
                                <div class="aside-block__item aside-block-item">
                                    <a class="aside-block-item__img" href="#">
                                        <img class="aside-block-item__img-image" src="images/member-icon-27.png"
                                             alt="img">
                                    </a>
                                    <div class="aside-block-item__box aside-block-item-box">
                                        <p class="aside-block-item-box__text">
                            ...
                            <div class="members-section-aside__aside-block aside-block aside-block--grid">
                                ...
                                <div class="aside-block__media aside-block-media">
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga1.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga2.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga3.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga4.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga5.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga6.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga7.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga8.jpg" alt="img">
                                    </a>
                                    <a class="aside-block-media__link" href="#">
                                        <img class="aside-block-media__link-img" src="images/new/ga4.jpg" alt="img">
                                    </a>
                        ...
                        <div class="groups__inner">
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-1.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                            ...
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-14.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-9.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-31.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-30.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/group-img-29.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                            <div class="groups__card card">
                            ...
                            <div class="groups__card card">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/event-img-4.jpg" alt="img">
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="courses__inner">
                            <div class="courses__card card card--courses">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/course-img-2.jpg" alt="img">
                            ...
                            <div class="courses__card card card--courses">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/course-img-7.jpg" alt="img">
                                        <p class="card-box__poster-text">
                                            $150
                                        </p>
                                    </a>
                            ...
                            <div class="courses__card card card--courses">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/course-img-6.jpg" alt="img">
                                        <p class="card-box__poster-text">
                                            $40-60
                                        </p>
                                    </a>
                            ...
                            <div class="courses__card card card--courses">
                                <div class="card__inner">
                                    ...
                                    <a class="card-box__poster" href="#">
                                        <img class="card-box__poster-img" src="images/course-img-1.jpg" alt="img">
                                        <p class="card-box__poster-text">
                                            $65
                                        </p>
                                    </a>
